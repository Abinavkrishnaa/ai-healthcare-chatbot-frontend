...
const HeroSection = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-blue-800 to-cyan-700 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      <motion.div
      ...
      >
        <motion.div
          ...
          className="mb-6"
        >
          <svg className="w-24 h-24 mx-auto text-cyan-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        ...
        >
          Get instant medical insights about your symptoms and connect with the right healthcare specialists. Your personal AI medical assistant is here to guide you.
        </motion.p>
      ...
      >
        <p>Powered by Advanced AI - Not a substitute for professional medical advice</p>
      </motion.div>
