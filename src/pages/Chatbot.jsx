...
const Chatbot = () => {
  ...
  const nextStep = () => {
    ...
    if (
      ...
      currentField !== "existing_conditions" &&
  ...
  return (
    <div className="w-full min-h-screen bg-gray-900 text-white flex flex-col">
      {/* Header */}
      <header className="w-full bg-gradient-to-r from-indigo-900 to-blue-800 py-4 px-4 shadow-md">
      ...
      <div className="flex-grow w-full mx-auto px-4 py-8">
        {!response ? (
          <motion.div
            className="bg-gray-800 rounded-xl shadow-xl overflow-hidden max-w-4xl mx-auto"
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.h3
                    ...
                    className="text-xl font-medium text-cyan-300"
                  >
          ...
          >
            <div className="flex items-center">
              ...
              <h2 className="text-2xl font-bold">
                Your Medical Assessment Results
              </h2>
            </div>
              ...
              <div className="p-6 space-y-6">
                  ...
                  <motion.div variants={itemVariants} className="space-y-3">
                    ...
                    <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
                      <iframe
                        ...
                        src={response.youtube_link.replace(
                          "watch?v=",
                          "embed/"
                        )}
                ...
                >
                  <div className="flex items-start">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6 text-red-400 mr-2 mt-1 flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
          ...
          >
            ...
            >
              ...
              <p className="text-gray-400 mt-2 text-center">
                Our AI is processing your information and consulting medical
                databases.
              </p>
            </motion.div>
          </motion.div>
      ...
      <footer className="w-full bg-gray-800 py-4 text-center text-gray-400 text-sm">
        <p>
          © 2025 MediAssist. This is an AI assistant and not a substitute for
